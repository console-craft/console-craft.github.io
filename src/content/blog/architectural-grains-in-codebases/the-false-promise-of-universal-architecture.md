...
The rest of this article introduces the main concepts that we will explore in the ["Architectural Grains in Codebases"](../) series.
...
In the next article in this series we will discuss [React's native geometry](../reacts-native-geometry) and why React is more than "just the view layer".
